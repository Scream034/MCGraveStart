...
# Сообщаем об успехе
tellraw @s ["",{"text":"[Grave Star] ","color":"gold"},{"text":"Глобальный спавн для могил установлен на: ","color":"green"},{"score":{"name":"#global_x","objective":"gs_config"},"color":"white"},{"text":" ","color":"white"},{"score":{"name":"#global_y","objective":"gs_config"},"color":"white"},{"text":" ","color":"white"},{"score":{"name":"#global_z","objective":"gs_config"},"color":"white"}]
